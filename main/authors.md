...
Source:
[`DESCRIPTION`](https://github.com/insightsengineering/autoslider.core/blob/main/DESCRIPTION)

Zhu J, Wang H, Zhao Y, Ci B, Li L, Duan X, Thoma S, Almond M, Lv C,
Uzunovic J, Zhou Y (2025). *autoslider.core: Slide Automation for
Tables, Listings and Figures*. R package version 0.3.1.9002,
