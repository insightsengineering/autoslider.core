...
Below is an example presentation output with placeholder slides, 
```{r}


knitr::include_graphics("pharmaverse output 1.png")

knitr::include_graphics("pharmaverse output 2.png")
```
