...
The `autoslideR` workflow is pretty much the same as the `EnableRF` workflow that was established for enableR.
Anyone who used the [`EnableRF` package](https://github.roche.com/Rpackages/EnableRF) before should find the `autoslideR` approach really familiar. 
[A demo repo that highlights the entire workflow can be found here.](https://code.roche.com/dss-rac/autoslider-demo)
...
It can be created from scratch or [extracted from a gLOPO](Not sure how). 
