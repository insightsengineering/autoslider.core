...
# Set the root directory for all chunks to the project's top-level folder
knitr::opts_chunk$set(root.dir = here())
```
```{r}
# This code will be both executed and shown
outputs %>%
  generate_slides(
...
generate_slides(outputs, outfile = filepath,
                template = "path/to/your/custom_template.pptx")
```
